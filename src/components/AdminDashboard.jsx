...
const DEFAULT_MENU_DATA = [
    // Minuman
    { name: 'TEA', variant: 'LEMON TEA', price: 5000, category: 'minuman', image: drinkThumb, id: 'def-1' },
    { name: 'TEA', variant: 'LYCHEE TEA', price: 5000, category: 'minuman', image: drinkThumb, id: 'def-2' },
    { name: 'TEA', variant: 'MANGO TEA', price: 5000, category: 'minuman', image: drinkThumb, id: 'def-3' },
    { name: 'TEA', variant: 'STRAWBERRY TEA', price: 5000, category: 'minuman', image: drinkThumb, id: 'def-4' },
    { name: 'TEA', variant: 'GRAPE TEA', price: 5000, category: 'minuman', image: drinkThumb, id: 'def-5' },
    { name: 'TEA', variant: 'MELON TEA', price: 5000, category: 'minuman', image: drinkThumb, id: 'def-6' },
    { name: 'YAKULT', variant: 'YAKULT STRAWBERRY', price: 8000, category: 'minuman', image: drinkThumb, id: 'def-7' },
    { name: 'YAKULT', variant: 'YAKULT ORANGE', price: 8000, category: 'minuman', image: drinkThumb, id: 'def-8' },
    { name: 'YAKULT', variant: 'YAKULT GRAPE', price: 8000, category: 'minuman', image: drinkThumb, id: 'def-9' },
    { name: 'YAKULT', variant: 'YAKULT LYCHEE', price: 8000, category: 'minuman', image: drinkThumb, id: 'def-10' },
    { name: 'YAKULT', variant: 'YAKULT MELON', price: 8000, category: 'minuman', image: drinkThumb, id: 'def-11' },
    { name: 'ES TELER', variant: 'ES TELER CREAMY', price: 10000, category: 'minuman', image: drinkThumb, id: 'def-12' },
    { name: 'MOJITO', variant: 'MOJITO STRAWBERRY', price: 8000, category: 'minuman', image: drinkThumb, id: 'def-13' },
    { name: 'MOJITO', variant: 'MOJITO LEMON', price: 8000, category: 'minuman', image: drinkThumb, id: 'def-14' },
    { name: 'MOJITO', variant: 'MOJITO MELON', price: 8000, category: 'minuman', image: drinkThumb, id: 'def-15' },
    { name: 'MOJITO', variant: 'MOJITO LYCHEE', price: 8000, category: 'minuman', image: drinkThumb, id: 'def-16' },
    { name: 'MOJITO', variant: 'MOJITO ORANGE', price: 8000, category: 'minuman', image: drinkThumb, id: 'def-17' },
    { name: 'MOJITO', variant: 'MOJITO GRAPE', price: 8000, category: 'minuman', image: drinkThumb, id: 'def-18' },
    { name: 'ALPUKAT KOCOK', variant: 'ORIGINAL', price: 10000, category: 'minuman', image: drinkThumb, id: 'def-19' },
    { name: 'ALPUKAT KOCOK', variant: 'MILO', price: 10000, category: 'minuman', image: drinkThumb, id: 'def-20' },
    { name: 'ALPUKAT KOCOK', variant: 'KEJU BERUTAL', price: 10000, category: 'minuman', image: drinkThumb, id: 'def-21' },
    { name: 'ALPUKAT KOCOK', variant: 'COKLAT + KEJU', price: 10000, category: 'minuman', image: drinkThumb, id: 'def-22' },
    { name: 'ALPUKAT KOCOK', variant: 'COKLAT PARUT', price: 10000, category: 'minuman', image: drinkThumb, id: 'def-23' },
    // Makanan (Seblak)
    { name: 'SEBLAK REGULER', variant: 'SEBLAK SOSIS', price: 10000, category: 'makanan', image: foodThumb, id: 'def-24' },
    { name: 'SEBLAK REGULER', variant: 'SEBLAK BAKSO', price: 10000, category: 'makanan', image: foodThumb, id: 'def-25' },
    { name: 'SEBLAK REGULER', variant: 'SEBLAK HEMAT', price: 10000, category: 'makanan', image: foodThumb, id: 'def-26' },
    { name: 'SEBLAK REGULER', variant: 'SEBLAK BIASA', price: 12000, category: 'makanan', image: foodThumb, id: 'def-27' },
    { name: 'SEBLAK PREMIUM', variant: 'SEBLAK CUANKI 🔥', price: 15000, category: 'makanan', image: foodThumb, id: 'def-28' },
    { name: 'SEBLAK PREMIUM', variant: 'SEBLAK SPESIAL', price: 15000, category: 'makanan', image: foodThumb, id: 'def-29' },
    { name: 'SEBLAK PREMIUM', variant: 'SEBLAK ISTIMEWA', price: 20000, category: 'makanan', image: foodThumb, id: 'def-30' },
    { name: 'SEBLAK EXTRA', variant: 'SEBLAK BLENGER', price: 30000, category: 'makanan', image: foodThumb, id: 'def-31' },
];
